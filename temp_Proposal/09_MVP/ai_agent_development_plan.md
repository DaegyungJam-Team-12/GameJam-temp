...
개발자 실행용 문서: `11_Handoff/ICEBREAKER_개발자_WBS_작업전달서.docx` — 개발자별 일일 Task, 선행 의존성, 난이도·예상시간, 브랜치, 완료 조건, AI·PR 체크리스트를 제공한다.
...
| 7/21 화요일 18:00 | 정비 14개·특수빙·보조·연쇄·목적지·창 연결 | 신규 기능 금지, `LEAD`가 미완성 핵심을 직접 인수 |
...
커서 범위 자동 파쇄, T1~T3, 결정빙·균열빙, 정비 14개, 세 목적지, 자금 정산, 저장, 축소 런처는 컷하지 않는다.
